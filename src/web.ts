...
export class CapacitorIvsPlayerWeb extends WebPlugin implements CapacitorIvsPlayerPlugin {
  ...
  async setBackgroundState(options: { backgroundState: CapacitorIvsPlayerBackgroundState }): Promise<void> {
