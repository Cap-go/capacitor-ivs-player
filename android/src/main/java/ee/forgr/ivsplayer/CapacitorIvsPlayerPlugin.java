...
public class CapacitorIvsPlayerPlugin extends Plugin {
    ...
    private void _setPlayerPosition(Boolean toBack) {
        if (toBack) {
            ...
            getBridge().getActivity().findViewById(mainPiPFrameLayoutId).setBackgroundColor(Color.parseColor("#00000000"));
            FrameLayout mainPiPFrameLayout = getBridge().getActivity().findViewById(mainPiPFrameLayoutId);
    ...
    private void _setFrame(int x, int y, int width, int height, boolean forceSetFrame) {
